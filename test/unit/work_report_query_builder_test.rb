...
class WorkReportQueryBuilderTest < ActiveSupport::TestCase
  test 'build query for day report' do
    ...
    expected_query = CGI.unescape('/time_entries?c%5B%5D=project&c%5B%5D=spent_on' \
    ...
    assert_equal expected_query, CGI.unescape(WorkReportQueryBuilder.new(work_report_query).build_query)
  end
